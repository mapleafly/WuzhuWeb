package org.lifxue.wuzhu.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 org.lifxue.wuzhu.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
