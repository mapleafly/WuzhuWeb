package org.lifxue.wuzhu.module.infra.service.codegen.inner;
...
import org.lifxue.wuzhu.framework.apilog.core.enums.OperateTypeEnum;
import org.lifxue.wuzhu.framework.common.exception.util.ServiceExceptionUtil;
...
import org.lifxue.wuzhu.framework.excel.core.annotations.DictFormat;
import org.lifxue.wuzhu.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "wuzhu-module-${table.moduleName}/" + // 顶级模块
                "wuzhu-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "wuzhu-module-${table.moduleName}/" + // 顶级模块
                "wuzhu-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "wuzhu-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "wuzhu-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
