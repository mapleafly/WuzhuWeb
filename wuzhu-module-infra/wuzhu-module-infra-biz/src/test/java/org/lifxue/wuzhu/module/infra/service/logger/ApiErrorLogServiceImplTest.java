package org.lifxue.wuzhu.module.infra.service.logger;
...
import org.lifxue.wuzhu.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import org.lifxue.wuzhu.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import org.lifxue.wuzhu.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import org.lifxue.wuzhu.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static org.lifxue.wuzhu.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static org.lifxue.wuzhu.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("wuzhu-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("wuzhu-test");
