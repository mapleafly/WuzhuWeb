package org.lifxue.wuzhu.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${wuzhu.websocket.sender-rocketmq.topic}",
        consumerGroup = "${wuzhu.websocket.sender-rocketmq.consumer-group}",
