 ...
 *      1）Spring Async：
 *          {@link org.lifxue.wuzhu.framework.quartz.config.WuzhuAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 WuzhuSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package org.lifxue.wuzhu.framework.tenant;
