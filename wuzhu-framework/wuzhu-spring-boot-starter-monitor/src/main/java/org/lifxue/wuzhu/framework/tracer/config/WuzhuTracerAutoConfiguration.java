...
import org.lifxue.wuzhu.framework.tracer.core.aop.BizTraceAspect;
import org.lifxue.wuzhu.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "wuzhu.tracer", value = "enable", matchIfMissing = true)
public class WuzhuTracerAutoConfiguration {
