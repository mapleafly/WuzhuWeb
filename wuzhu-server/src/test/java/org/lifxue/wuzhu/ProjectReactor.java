...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "org.lifxue.wuzhu";
    private static final String ARTIFACT_ID = "wuzhu";
    private static final String PACKAGE_NAME = "org.lifxue.wuzhu";
    private static final String TITLE = "五铢-个人账务软件";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "org.lifxue.wuzhu";
        String artifactIdNew = "wuzhu";
        String packageNameNew = "org.lifxue.wuzhu";
        String titleNew = "五铢-个人账务软件";
