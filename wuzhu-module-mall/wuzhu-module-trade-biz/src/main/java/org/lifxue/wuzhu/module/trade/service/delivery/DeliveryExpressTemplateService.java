...
import org.lifxue.wuzhu.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateCreateReqVO;
import org.lifxue.wuzhu.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateDetailRespVO;
import org.lifxue.wuzhu.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplatePageReqVO;
import org.lifxue.wuzhu.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateUpdateReqVO;
...
public interface DeliveryExpressTemplateService {
     ...
     * 校验快递运费模板
     *
     * 如果校验不通过，抛出 {@link org.lifxue.wuzhu.framework.common.exception.ServiceException} 异常
     *
