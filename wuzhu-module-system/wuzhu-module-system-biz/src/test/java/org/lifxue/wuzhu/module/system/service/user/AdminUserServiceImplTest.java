package org.lifxue.wuzhu.module.system.service.user;
...
import org.lifxue.wuzhu.framework.common.util.collection.ArrayUtils;
...
import org.lifxue.wuzhu.module.infra.api.file.FileApi;
import org.lifxue.wuzhu.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import org.lifxue.wuzhu.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import org.lifxue.wuzhu.module.system.controller.admin.user.vo.user.*;
...
import org.lifxue.wuzhu.module.system.dal.dataobject.dept.UserPostDO;
...
import org.lifxue.wuzhu.module.system.dal.mysql.dept.UserPostMapper;
import org.lifxue.wuzhu.module.system.dal.mysql.user.AdminUserMapper;
import org.lifxue.wuzhu.module.system.enums.common.SexEnum;
import org.lifxue.wuzhu.module.system.service.dept.DeptService;
...
import org.lifxue.wuzhu.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("wuzhuyuanma");
        ...
        assertEquals("wuzhuyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("wuzhuyuanma"))).thenReturn("java");
