package org.lifxue.wuzhu.module.bpm.controller.admin.definition.vo.process;
...
public class BpmProcessDefinitionRespVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "wuzhu")
    private String key;

    @Schema(description = "流程图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iocoder.cn/wuzhu.jpg")
    private String icon;
